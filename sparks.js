/*=============================================================================*/
			...
			/*=============================================================================*/
			  this.renderL = function(){
				...
				while(i--){
				  ...
				  if(!light.hasFired){
					this.ctx.fillStyle = 'rgba(248, 248, 255, '+this.rand(4, 12)/100+')';
					this.ctx.fillRect(0, 0, this.cw, this.ch);
				  }

				  if(this.rand(5000, 10000) == 0){
					this.ctx.fillStyle = 'rgba(248, 248, 255, '+this.rand(1, 3)/100+')';
					this.ctx.fillRect(0, 0, this.cw, this.ch);
				  }
			...
			/*=============================================================================*/
			  this.lightningTimer = function(){
				...
				if(this.lightTimeCurrent >= this.lightTimeTotal){
				  ...
				  this.lightTimeCurrent = 0;
				  this.lightTimeTotal = this.rand(10, 50);
				}
			  }
			...
			var isCanvasSupported = function(){
			  var elem = document.createElement('canvasLightning');
			...
			if(isCanvasSupported){
				var c = document.getElementById('canvasLightning');
